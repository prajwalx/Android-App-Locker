...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            showProgress(true);
            String method="login";
            mAuthTask = new BackGroundTask(method,email,password,this);
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, String> {
        ...
        String method="login",name,phone;
        ...
        protected String doInBackground(Void...params) {
            ...
            //if(method.equals("login"))
            {
                ...
                //mPassword=strings[2];
                try {
                    URL url = new URL("http://192.168.1.9/MyProject/Login.php");
                    Toast.makeText(getApplicationContext(),"URL Connection",Toast.LENGTH_LONG).show();
            ...
            if(method.equals("register"))
            {
                ...
                //name=strings[3];
                //phone=strings[4];
                System.out.println(name+" "+mEmail+" "+mPassword);

                try {
                    URL url=new URL("http://fdfdfd");
                    HttpURLConnection httpURLConnection=(HttpURLConnection) url.openConnection();
                    httpURLConnection.setRequestMethod("POST");
                    httpURLConnection.setDoOutput(true);
                    OutputStream os=httpURLConnection.getOutputStream();
